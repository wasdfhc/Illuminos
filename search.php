...
echo '<div>';
    ...
    echo "<a class='filters_a' href='?sort=id&order=" . ($sortColumn === 'id' && $order === 'ASC' ? 'DESC' : 'ASC') . "'>По добавлению</a>";
    echo '</div>';
...
<body>
    ...
    <?php
    // Подключение к базе данных
    $conn = mysqli_connect("localhost", "root", "", "illuminos");
    ...
    if(isset($_POST['submit'])) {
        ...
        // Очистка и экранирование значения поиска
        $search = mysqli_real_escape_string($conn, $search);

        // SQL запрос для поиска товаров
        $sql = "SELECT * FROM all_product WHERE name LIKE '%$search%'";
