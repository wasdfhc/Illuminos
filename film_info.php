...
<div class="content">
   ...
   <a href="films.php" class="nazad">Назад</a>
                ...
                if ($result = $conn->query($sql)) {
                    ...
                    <div class="trailer_film">
                        ...
                        <div class="description_film">
                            <p class="name_film"><?php echo $row["name"]; ?></p>
                            <div class="small_description">
                                <p><?php echo $row["age"]; ?></p>
                                <p><?php echo $row["estimation"]; ?></p>
        ...
        <div class="reviews_content">
           <div class="text_rew">
            <?php
        $sql = "SELECT * FROM serials WHERE serial_id = " . $id;
        if ($result = $conn->query($sql)) {
            while ($row = $result->fetch_assoc()) { ?>
    ...
    if ($result = $conn->query($sql)) {
        ...
        <div class="card">
            <div class="reccomend">
            <a href="film_info.php?film_id=<?php echo $row["film_id"]; ?>">                   
